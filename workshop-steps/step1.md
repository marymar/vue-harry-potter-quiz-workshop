...
Create a new sandbox Vue project by going to CodeSandbox and clicking on the “Create Sandbox” box. The options for which kind of sandbox you want to have will appear. There you choose Vue as the basis for your sandbox. The instant IDE will then set up a base Vue project for you.
